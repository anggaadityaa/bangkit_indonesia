...
<body>
    ...
    <main id="main">
        ...
        <!-- Galeri -->
        <!-- ======= Our Services Section ======= -->
        <section id="galeri" class="services sections-bg">
            <div class="container" data-aos="fade-up">

                <div class="section-header">
                    <h2>Galeri Bangkitkan Semangat Indonesia</h2>
                    <p></p>
                </div>
                ...
                <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    foreach ($data as $row) : ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="service-item  position-relative">
                                <p><img src="<?= "admin/img_galeri/" . $row['gambar'] ?>" width="290" height="200"></p>
                                <p><?= substr($row['keterangan'], 0, 200) ?></p>
                                <a href="detail_galeri.php?id=<?= $row['id'] ?>" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div><!-- End Service Item -->
                    <?php endforeach; ?>
                </div>
